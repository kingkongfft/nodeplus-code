// Minimal standalone repro: does powershell.exe -NoLogo -NoExit under ConPTY exit
...
int main() {
    ...
    std::wstring cmdLine = L"\"C:\\Program Files\\PowerShell\\7\\powershell.exe\" -NoLogo -NoExit";
    wchar_t cmdBuf[1024] = {};
