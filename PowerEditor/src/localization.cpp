...
//==============================================
	...
	{ 5,   5, -1, "encoding-characterSets" },
	{ 5,   5,  0, "encoding-arabic" },
	{ 5,   5,  1, "encoding-baltic" },
	{ 5,   5,  2, "encoding-celtic" },
	{ 5,   5,  3, "encoding-cyrillic" },
	{ 5,   5,  4, "encoding-centralEuropean" },
	{ 5,   5,  5, "encoding-chinese" },
	{ 5,   5,  6, "encoding-easternEuropean" },
	{ 5,   5,  7, "encoding-greek" },
	{ 5,   5,  8, "encoding-hebrew" },
	{ 5,   5,  9, "encoding-japanese" },
	{ 5,   5, 10, "encoding-korean" },
	{ 5,   5, 11, "encoding-northEuropean" },
	{ 5,   5, 12, "encoding-thai" },
	{ 5,   5, 13, "encoding-turkish" },
	{ 5,   5, 14, "encoding-westernEuropean" },
	{ 5,   5, 15, "encoding-vietnamese" },

	{ 6,  25, -1, "language-userDefinedLanguage" },

	{ 7,   4, -1, "settings-import" },
